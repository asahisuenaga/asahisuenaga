...
<ul>
    ...
    <li>Made <a href="https://chromewebstore.google.com/detail/hide-google-ai-overviews/pkbhdojajlnigelihhbclnikhidgnbeo?hl=en&authuser=0" style="color:rgb(234, 179, 8);">Hide Google AI Overviews and Mode</a>, a browser extension with 300,000 users that hides Google's AI elements from search.</li>
    <li>Developed <a href="https://chromewebstore.google.com/detail/rainbow-cursor-in-google/nnmghknojpihdnofejbocdcnmhibkfdc" style="color:rgb(234, 179, 8);; text-decoration: underline;">Rainbow Cursor</a>, an open-source browser extension with 3,000 users that swaps the cursor in Google Docs to a <span style="background: linear-gradient(to right, #ffb6c1, #ff69b4, #da70d6, #9370db, #48c9b0, #f0e68c, #ffd700); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">rainbow</span> one.</li>
